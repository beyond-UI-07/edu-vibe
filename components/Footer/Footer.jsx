...
export default function Footer() {
  return (
    <section className="bg-gradient-to-r from-primary-600 to-primary-400 text-white"><footer className="container mx-auto py-4 md:py-7 px-3 md:px-10 ">
    <div className="container py-12">
      <div className="grid gap-8 md:grid-cols-4">
        <div>
          <div className="flex items-center space-x-2 mb-4">
            <Image alt="Logo" src="/logo2.png" width={140} height={140}/>
          </div>
        ...
        <div>
          ...
          <p className="text-sm opacity-90 mb-4">
            Stay updated with the latest news, resources, and special offers.
          </p>
          <div className="flex">
            <input
              type="email"
